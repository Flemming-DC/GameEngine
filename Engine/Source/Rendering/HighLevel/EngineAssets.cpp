...
void EngineAssets::Setup()
{
	...
	map_uo<string, std::any> uniformsByName1 = { {"u_color", vec4(0.0f, 1.0f, 0.0f, 1.0f)} };
	gizmoMaterial = Material::register_.Add("gizmo", EngineAssets::SolidColorShader(), uniformsByName1);

    map_uo<string, std::any> uniformsByName2 = { {"u_color", vec4(0.5f, 0.5f, 0.5f, 1.0f)} };
    defaultMaterial = Material::register_.Add("default", EngineAssets::SolidColorShader(), uniformsByName2);
